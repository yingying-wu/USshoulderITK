...
"yy_3_26_2014" series
- screen X1 = 192; Y1 = 31; X2 = 588; Y2 = 411;
- top	 X1 = 114; Y1 = 0; X2 = 286; Y2 = 180; 
- bottom X1 = 97; Y1 = 180; X2 = 302; Y2 = 380;
- bright sigmoid beta = 110; alpha = 50; 
- dark sigmoid beta = 50; alpha = 20;

"friday_test" series
- screen X1 = 190; Y1 = 31; X2 = 586; Y2 = 411;
- top	 X1 = 110; Y1 = 0; X2 = 282; Y2 = 180; 
- bottom X1 = 93; Y1 = 180; X2 = 298; Y2 = 380;
- bright sigmoid beta = 110; alpha = 50; 
- dark sigmoid beta = 50; alpha = 20;
...
int main( int argc, char * argv[] )
{
  ...
  // declare typedefs here
	...
	sigmoidTop->SetBeta( atof(argv[1]) );
	sigmoidTop->SetAlpha( atof(argv[2]) );
	...
	if (!showWhich.compare("bright")) sitk::Show( sitk::Image( sigmoidImageTop ), "sigmoidImageTop");
	...
	sigmoidBot->SetBeta( atof(argv[3]) );
	sigmoidBot->SetAlpha( atof(argv[4]) );
	...
	if (!showWhich.compare("dark")) sitk::Show( sitk::Image( sigmoidImageBot ), "sigmoidImageBot");
